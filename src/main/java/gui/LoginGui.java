...
public class LoginGui extends JFrame {
    ...
    private JButton loginBtn = new JButton("ACCEDI");
    private JButton registerBtn = new JButton("REGISTRATI");
    ...
    public LoginGui() {
        ...
        styleButton(loginBtn, ORANGE, Color.WHITE);
        styleButton(registerBtn, new Color(50, 50, 50), Color.WHITE);
    ...
    public void setLoginAction(ActionListener al) { loginBtn.addActionListener(al); }
